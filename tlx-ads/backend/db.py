...
def init_db() -> None:
    ...
    with get_db() as db:
        ...
        db.execute("CREATE INDEX IF NOT EXISTS idx_campaigns_name ON campaigns(tenant_id, name);")
        db.execute("CREATE INDEX IF NOT EXISTS idx_campaigns_status ON campaigns(tenant_id, status);")
        db.execute("CREATE INDEX IF NOT EXISTS idx_contacts_tenant ON contacts(tenant_id, id);")
        db.execute("CREATE INDEX IF NOT EXISTS idx_contacts_email ON contacts(tenant_id, email);")
        db.execute("CREATE INDEX IF NOT EXISTS idx_contacts_phone ON contacts(tenant_id, phone);")
        db.execute("CREATE INDEX IF NOT EXISTS idx_contacts_name ON contacts(tenant_id, name);")
        db.execute("CREATE INDEX IF NOT EXISTS idx_segments_tenant ON segments(tenant_id, id);")
        db.execute("CREATE INDEX IF NOT EXISTS idx_segments_name ON segments(tenant_id, name);")
